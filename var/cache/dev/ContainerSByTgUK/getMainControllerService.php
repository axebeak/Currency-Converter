...
$this->services['App\Controller\MainController'] = $instance = new \App\Controller\MainController(new \App\Service\FileHelper(27.09, 30.48), new \App\Service\APIHelper('https://api.privatbank.ua/p24api/pubinfo?json&exchange&coursid=5'), new \App\Service\RandomHelper());
